    ...
    <nav className="w-full mx-auto h-[70px] md:h-[94px] flex items-center justify-between px-5 md:px-20 py-[25px] bg-[#181A1C] text-white">
      ...
      <div className="flex items-center gap-[12px] w-[268px] h-[44px] md:gap-[80px] md:w-[520px] md:h-[44px]">
        <div className="flex items-center gap-[4px] w-auto h-[44px]">
          ...
          <span className="hidden md:inline text-[32px] leading-[55px] font-normal font-londrina">CHILL</span>
        </div>

        {/* Links → diblok navigasinya */}
        <div className="flex items-center space-x-4 md:space-x-8 text-[12px] md:text-[18px] font-medium font-lato">
          <Link to="/series" onClick={blockNav} className="text-white hover:text-gray-400 cursor-default">
            Series
          </Link>
          <Link to="/film" onClick={blockNav} className="text-white hover:text-gray-400 cursor-default">
            Film
          </Link>
          <Link to="/daftar-saya" onClick={blockNav} className="text-white hover:text-gray-400 min-w-[80px] tracking-[0.2px] text-center cursor-default">
            Daftar Saya
          </Link>
        </div>
      </div>
      ...
      <div className="relative ml-auto" onMouseEnter={openMenu} onMouseLeave={closeMenuSoft}>
        ...
        >
          ...
          <Link to="/profil" onClick={blockNav} className="flex items-center px-3 py-2 text-sm md:px-4 md:py-3 md:text-base hover:bg-gray-800 text-white hover:text-blue-500">
          ...
          <Link to="/premium" onClick={blockNav} className="flex items-center px-3 py-2 text-sm md:px-4 md:py-3 md:text-base hover:bg-gray-800 text-white hover:text-blue-500">
